...
<!--                                            id="idinstitucion">-->
<!--                                            --><?php //foreach ($instituciones as $institucion) {  ?>
<!--                                                <option value="--><?php //echo $institucion['id']; ?><!--">-->
<!--                                                    --><?php //echo $institucion['nombre']; ?><!--</option>-->
<!--                                            --><?php // } ?>
<!--                                        </select>-->
<!--                                    </div>-->
<!--                                    <div class="mb-3">-->
...
<!--script>
    document.getElementById("btnCompartir").addEventListener("click", function() {
        ...
        var url_documento =
            "http://localhost/sis_documentos/public/documentos/<?php echo $archivo['documento']; ?>";


        var campoTemporal = document.createElement("textarea");
        campoTemporal.value = url_documento;
        ...
        alert("¡La URL del archivo ha sido copiado!");
    });
</script-->
